        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg opacity-60">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <span className="font-medium text-gray-400">Manage all users</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg opacity-60">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">System Config</dt>
                      <dd className="text-lg font-medium text-gray-900">Coming Soon</dd>
                    </dl>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <span className="font-medium text-gray-400">System settings</span>
                </div>
              </div>
            </div>
          </div>
