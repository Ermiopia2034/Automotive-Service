...
export default function GarageAdminApplicationsPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Mechanic Applications</h1>
            <p className="text-sm text-gray-600 mt-1">Review mechanic applications for your garage</p>
          </div>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">
              Mechanic Applications ({applications.length})
            </h3>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-6 text-center text-gray-500">
              {filter === 'pending' 
                ? 'No pending mechanic applications for your garage.'
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <span className="px-2 py-1 text-xs bg-purple-100 text-purple-800 rounded-full">MECHANIC</span>
                      ...
                      <div className="bg-gray-50 p-3 rounded text-sm">
                        ...
                        <p className="mt-1 text-gray-600">
                          User {application.applicant.firstName} {application.applicant.lastName} has applied to work as a mechanic at your garage.
                          If approved, they will be able to accept service requests and manage vehicle repairs.
                        </p>
                      </div>
                    </div>
